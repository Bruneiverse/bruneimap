...
Or, if preferred, you may install the development version of bruneimap from [GitHub](https://github.com/) using:
...
The Brunei map was generated from publicly available [Survey Department](https://geoportal.survey.gov.bn/start-gp) data. 
The GeoJSON files were sourced from [thewheat/brunei_map](https://github.com/thewheat/brunei_map) GitHub repo. 
It comes with a neat [web app](http://thewheat.github.io/brunei_map/). 
